<template>
  <div class="min-h-screen bg-white">
    <!-- Hero Section -->
    <section class="pt-20 pb-16 lg:pt-28 lg:pb-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-600 to-primary-800">
      <div class="max-w-7xl mx-auto text-center">
        <div class="mb-8">
          <span class="inline-block bg-white/20 text-white text-sm font-semibold px-4 py-2 rounded-full mb-4">
            🎯 {{ $t('enterit.badge') }}
          </span>
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-4xl mx-auto mb-8">
          ...
          <!-- Registration CTA -->
          <div class="text-center">
            <button class="bg-primary-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-primary-700 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-lg">
        ...
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-start space-x-4">
              ...
              <div>
                <h3 class="text-xl font-semibold text-gray-900 mb-3">{{ $t('enterit.modules.jobSearch.title') }}</h3>
          ...
          <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-start space-x-4">
              ...
              <div>
                <h3 class="text-xl font-semibold text-gray-900 mb-3">{{ $t('enterit.modules.interview.title') }}</h3>
                <ul class="space-y-2 text-gray-600">
                  <li class="flex items-start space-x-2">
                    <svg class="w-5 h-5 text-success-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
          ...
          <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-start space-x-4">
              ...
              <div>
                <h3 class="text-xl font-semibold text-gray-900 mb-3">{{ $t('enterit.modules.recruiters.title') }}</h3>
                <ul class="space-y-2 text-gray-600">
                  <li class="flex items-start space-x-2">
                    <svg class="w-5 h-5 text-success-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
          ...
          <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-start space-x-4">
              ...
              <div>
                <h3 class="text-xl font-semibold text-gray-900 mb-3">{{ $t('enterit.modules.aiLearning.title') }}</h3>
                <ul class="space-y-2 text-gray-600">
                  <li class="flex items-start space-x-2">
                    <svg class="w-5 h-5 text-success-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
    ...
    <section class="py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-12 max-w-5xl mx-auto">
          <div class="lg:w-1/3">
            <div class="w-64 h-64 bg-gradient-to-br from-primary-400 to-primary-600 rounded-full flex items-center justify-center mx-auto shadow-2xl">
          ...
          <div class="lg:w-2/3 text-center lg:text-left">
            ...
            <p class="text-lg text-primary-600 font-semibold mb-4">{{ $t('enterit.speaker.role') }}</p>
    ...
    <section class="py-16 bg-gradient-to-br from-primary-600 to-primary-800">
      <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <button class="bg-white text-primary-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg text-lg">
